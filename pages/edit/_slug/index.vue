<template>
  <div class="edit flex-column">
    ...
    <form @submit.prevent="editVulnerability" class="flex-column" ref="form" v-if="old_vulnerability">
      ...
      <button type="submit" class="btn btn-blue"> <fa class="icon-small" :icon="['fas', 'floppy-disk']" /> Submit </button>
